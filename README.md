...
local Window = Library:CreateWindow({
    ...
    KeySettings = {
        ...
        Key = {"48BUe7JbXHSg6wJMKsDD1miC9jrv3CXP"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
})
